  ...
  return (
    <div className="grid grid-flow-col p-5  shadow-sm">
      <div className="flex col-span-1">
        ...
        />
        <img
          className="ml-5 h-8 cursor-pointer"
          alt="youtube-logo"
      ...
      >
        <div>
          <input
            className="px-5 p-2 ml-[200px] w-1/2 border border-gray-400 rounded-l-full "
            placeholder="Search"
            type="text"
            value={searchQuery}
      ...
      <div className="flex mx-4">
        ...
        <span className=" text-2xl cursor-pointer hover:bg-gray-300 p-1 mx-4 rounded-full items-center  h-8">
          <CiBellOn />
        </span>

        <img
          className="h-8 col-span-1 cursor-pointer mx-2"
          alt="user-icon"
          src="https://media.istockphoto.com/id/1130884625/vector/user-member-vector-icon-for-ui-user-interface-or-profile-face-avatar-app-in-circle-design.jpg?s=612x612&w=0&k=20&c=1ky-gNHiS2iyLsUPQkxAtPBWH1BZt0PKBB1WBtxQJRE="
        />
        <span className="items-center font-bold my-1 cursor-pointer">
          Pinki Jha
        </span>
      </div>
    </div>
